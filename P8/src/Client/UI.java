...
public class UI extends javax.swing.JFrame {
    ...
    public void elegirip(){
        ...
        int rtn;
        //Verificar que dirección actual esté viva
        ask.setAddress(dir, 8888);
        rtn = ask.send();
        if(rtn == 1)
            return;
        else{
            System.out.println("Servidor "+dir+" está muerto");
            dir = null;
        }
        //Ya que la dir actual está muerta, busca una viva en las dirs
        for(String a: dirs){
            ask.setAddress(a, 8888);
            rtn = ask.send();
            if(rtn == 1){
                dir = a;
                break;
                ...
                System.out.println("Servidor "+a+" está muerto");
        }
    }
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        if(txtField_user.getText().length() != 0){
            ...
            elegirip();
            System.out.println("ip elegida registrar jugador: "+dir);
    ...
    private void btn_pedirCartaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pedirCartaActionPerformed
        elegirip();
        System.out.println("ip elegida pedir_carta: "+dir);
